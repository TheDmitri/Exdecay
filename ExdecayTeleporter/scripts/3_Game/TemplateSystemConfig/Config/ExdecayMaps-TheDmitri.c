class ExdecayMap
{
  ...
  void ExdecayMap(string mapName, bool isDisable, bool isFreshySpawn, int maxPlayer, int countdown, string imagepath, string mapDescription, float x1, float y1, float x2, float y2)
  {
    MapName   = mapName;
    IsDisable = isDisable;
    IsFreshySpawn = isFreshySpawn;
    MaxPlayer = maxPlayer;
    Countdown = countdown;
    ImagePath = imagepath;
