class ExdecayTeleporterSettings
{
	...
	void DefaultExdecayTeleporterSettings()
	{
		...
		Maps.Insert(new ExdecayMap("IceLand", false, false, 10, 30, "ExdecayTeleporter/gui/ICELAND.edds","This is a description frame to talk about your map features", 10722, 11866, 15241, 15100));
		...
		Maps.Insert(new ExdecayMap("ForestLand", false,false, 20, 30, "ExdecayTeleporter/gui/forestland.edds","This is a description frame to talk about your map features", 59, 1444,3411, 4461));
		...
		Maps.Insert(new ExdecayMap("FarmLand", false,false, 20, 30, "ExdecayTeleporter/gui/farmland.edds","This is a description frame to talk about your map features", 471, 7697,7137, 11096));
		...
		Maps.Insert(new ExdecayMap("CityLand", false,false, 20, 30, "ExdecayTeleporter/gui/cityland.edds","This is a description frame to talk about your map features", 7500, 7500,8500, 8500));
